...
wandb: Currently logged in as: engrghazalababar (engrghazalababar-nust). Use `wandb login --relogin` to force relogin
True
run = wandb.init(project=PROJECT, job_type="generation")
wandb version 0.19.8 is available! To upgrade, please run: $ pip install wandb --upgrade
Tracking run with wandb version 0.15.7
Run data is saved locally in /home/jovyan/work/L4/wandb/run-20250308_222456-kdxsvpo1
Syncing run summer-serenity-1 to Weights & Biases (docs)
View project at https://wandb.ai/engrghazalababar-nust/dlai_llm
View run at https://wandb.ai/engrghazalababar-nust/dlai_llm/runs/kdxsvpo1
Simple generations
...
generate_and_print(system_prompt, user_prompt, table)
Harmony Gems
Whimsical Gemstones: Radiant Treasures of Unity
Harmony Gems
Harmonious Gemstones
Harmony Gems
wandb.log({"simple_generations": table})
run.finish()
Waiting for W&B process to finish... (success).
0.005 MB of 0.005 MB uploaded (0.000 MB deduped)
View run summer-serenity-1 at: https://wandb.ai/engrghazalababar-nust/dlai_llm/runs/kdxsvpo1
Synced 5 W&B file(s), 1 media file(s), 1 artifact file(s) and 0 other file(s)
Find logs at: ./wandb/run-20250308_222456-kdxsvpo1/logs
