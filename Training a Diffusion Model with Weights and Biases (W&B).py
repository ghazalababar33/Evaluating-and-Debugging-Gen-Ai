...
# In this notebooks we will instrument the training of a diffusion model with W&B. We will use the Lab3 notebook from the "How diffusion models work" course. We will add:
...
You can visit the result of this >> training here <<
# create a wandb run
